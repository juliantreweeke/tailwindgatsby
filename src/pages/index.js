...
import BlueMountainsHeaderImage from "../images/BlueMountainsHeaderImage.jpg";
  ...
  return (
    ...
    <Controller>
        ...
        >
          <section className="bg-no-repeat bg-cover h-screen w-screen bg-white overflow-hidden" 
            ...
            <div className="py-64 px-16 py-4 text-black text-lg max-w-2xl">
              ...
              <p>
              Extensive expereince across agency, startup and the coporate sector come together to benefit our clients no matter what the project requires.
              </p>
              <p>
      ...
      >
        ...
        >
      <section className="h-screen px-16 w-screen py-16 overflow-hidden bg-white">
        <p className="py-24 text-4xl text-center font-medium">Clients we have helped include</p>
